...
router.get("/gazishadman/signup", (req, res) => {
    res.send("signup Route working!!")
})



router.post("/api/gazishadman/signup",
...
router.put("/api/gazishadman/user/:emailId",
    async (req, res) => {
...
router.get("/api/gazishadman/userlist", async (req, res) => {
    try {
...
router.delete("/api/gazishadman/delete/:id", async (req, res) => {
    try {
